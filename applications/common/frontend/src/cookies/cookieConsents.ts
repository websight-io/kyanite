...
document.addEventListener(window.KYANITE_ON_DOM_CONTENT_LOAD, () => {
  const config: CookieConfig = JSON.parse(document.body.dataset.cookieConfig);
      ...
      en: {
        ...
        settings_modal: {
          ...
          blocks: [
            {
              title: 'Cookie usage',
              description: `I use cookies to ensure the basic functionalities of the website and to enhance your online experience. You can choose for each category to opt-in/out whenever you want. For more details relative to cookies and other sensitive data, please read the full <a href="${config.privacyPolicyPath}" class="cc-link">privacy policy</a>.`,
            },
            {
            ...
            },
            {
              ...
              description: `For any queries in relation to our policy on cookies and your choices, please <a class="cc-link" href="${config.contactUsPath}">contact us</a>.`,
            },
          ],
        },
      },
