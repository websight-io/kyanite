...
class PagesSpaceComponentTest {
  ...
  @BeforeEach
  public void init() {
    context.addModelsForClasses(PagesSpaceComponent.class);
    context.load().json(requireNonNull(
        Thread.currentThread().getContextClassLoader().getResourceAsStream("pagesspace.json")), PATH);
  }
