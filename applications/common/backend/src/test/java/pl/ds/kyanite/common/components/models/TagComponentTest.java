...
import pl.ds.kyanite.common.components.models.TagComponent;
...
class TagComponentTest {
  ...
  public void init() {
    ...
    context.load().json(requireNonNull(
        Thread.currentThread().getContextClassLoader().getResourceAsStream("tag.json")), PATH);
  }

  @Test
  void defaultTagComponentModelTest() {
    TagComponent model = context.resourceResolver().getResource(PATH + "/default")
        .adaptTo(TagComponent.class);
  ...
  void tagComponentModelTest() {
    TagComponent model = context.resourceResolver().getResource(PATH + "/complex")
        .adaptTo(TagComponent.class);
