...
import pl.ds.kyanite.blogs.components.models.BlogArticleHeaderModel;
import pl.ds.kyanite.blogs.components.models.TagModel;
import pl.ds.kyanite.common.components.utils.DateFormatterUtil;
import pl.ds.kyanite.common.components.utils.LinkUtil;

@Model(
    adaptables = { Resource.class },
    adapters = { BlogArticleHeaderModel.class },
    defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL
)
public class BlogArticleHeaderModelImpl implements BlogArticleHeaderModel {
  ...
  @Inject
  public BlogArticleHeaderModelImpl(
