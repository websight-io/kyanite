...
package pl.ds.kyanite.blogs.components.models.impl;
...
import pl.ds.kyanite.blogs.components.models.BlogArticleHeaderComponent;
...
@Model(
    ...
    adapters = { BlogArticleHeaderComponent.class },
    defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL
)
public class BlogArticleHeaderComponentImpl implements BlogArticleHeaderComponent {
  ...
  @Getter
  private BlogArticleHeaderModelImpl blogArticleHeaderModel;
  ...
  @Inject
  public BlogArticleHeaderComponentImpl(
  ...
  private void resolveHeaderModel() {
    ...
    if (Objects.nonNull(currentPage)) {
      ...
      blogArticleHeaderModel = modelFactory.createModel(
          pageContent, BlogArticleHeaderModelImpl.class);
    }
  }
