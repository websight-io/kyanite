...
class ProgressBarComponentTest {
    ...
    public void init() {
        ...
        context.load().json(requireNonNull(
                Thread.currentThread().getContextClassLoader().getResourceAsStream("progressbar.json")), PATH);
    }

    @Test
    void defaultProgressBarComponentModelTest() {
        ProgressBarComponent model = context.resourceResolver().getResource(PATH + "/default").adaptTo(ProgressBarComponent.class);
    ...
    void isIntermediateModelTest() {
        ProgressBarComponent model = context.resourceResolver().getResource(PATH + "/isIntermediate").adaptTo(ProgressBarComponent.class);
    ...
    void valueSetModelTest() {
        ProgressBarComponent model = context.resourceResolver().getResource(PATH + "/valueSet").adaptTo(ProgressBarComponent.class);
