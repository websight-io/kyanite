...
class TitleComponentTest {
    ...
    void defaultTitleComponentModelTest() {
        TitleComponent model = context.resourceResolver().getResource(PATH + "/default").adaptTo(TitleComponent.class);

        assertThat(model).isNotNull();
        assertThat(model.getText()).isEqualTo("Title");
        assertThat(model.getType()).isEqualTo("title");
        assertThat(model.getElementType()).isEqualTo("h");
    ...
    void titleComponentModelTest() {
        TitleComponent model = context.resourceResolver().getResource(PATH + "/complex").adaptTo(TitleComponent.class);
