...
class PricingPlanComponentTest {
    ...
    public void init() {
        ...
        context.load().json(requireNonNull(
                Thread.currentThread().getContextClassLoader().getResourceAsStream("pricingplan.json")), PATH);
    }

    @Test
    void defaultPricingPlanComponentModelTest() {
        PricingPlanComponent model = context.resourceResolver().getResource(PATH + "/default").adaptTo(PricingPlanComponent.class);
    ...
    void pricingPlanComponentModelTest() {
        PricingPlanComponent model = context.resourceResolver().getResource(PATH + "/complex").adaptTo(PricingPlanComponent.class);
