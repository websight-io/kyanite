...
@Component
public class AddTableRowBeforeWebAction implements WebAction {

  private static final WebActionConfig CONFIG = WebActionConfig.Builder
      .newWebActionConfig("/apps/bulma-table-view/web-resources/actions/AddTableRowBeforeAction.js")
      .forAllModules()
      .forResourceTypes(
          Arrays.asList("bulma/components/table/tablerow", "bulma/components/table/tableheadcell",
              "bulma/components/table/tablecell"))
