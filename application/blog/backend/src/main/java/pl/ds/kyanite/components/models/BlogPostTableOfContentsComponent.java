...
public class BlogPostTableOfContentsComponent {
    ...
    private void init() {
        ...
        if (pageResource != null) {
            ...
            List<Resource> titles = findAllResourcesInContainerByType(contentsContainer, TITLE_RESOURCE_PATH);
            ...
            for (Resource contentTitle : titles) {
                ...
                if(!titleComponent.getElement().equals("p")){
                    BlogPostTableOfContentsItemComponent contentItem = prepareNewContentItem(titleComponent);
                    if (contentItem != null) {
    ...
    private BlogPostTableOfContentsItemComponent prepareNewContentItem(TitleComponent titleComponent) {
        if (titleComponent != null) {
            ...
            if (headingLevelValue != null && Integer.parseInt(headingLevelValue.substring(1)) >= this.maxHeadingLevel) {
                return new BlogPostTableOfContentsItemComponent(titleValue, anchorIdValue, headingLevelValue);
            }
        }
    ...
    private List<Resource> findAllResourcesInContainerByType(Resource container, String resourceType) {
